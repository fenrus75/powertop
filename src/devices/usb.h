...
public:
	...
	virtual std::string class_name(void) const override { return "usb";};

	virtual std::string device_name(void) const override { return devname; };
	...
	virtual int grouping_prio(void) const override { return 4; };
