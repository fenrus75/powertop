...
OBJS += process/process.o process/do_process.o process/interrupt.o process/timer.o process/work.o process/powerconsumer.cpp
OBJS += devices/device.o devices/backlight.o devices/usb.o devices/ahci.o devices/alsa.o
